// revision ErnestoGIM 22/02/2016
// Scott Camarena
...
#define Byte uint8_t              // define "Byte" de 8bits
#define ROUNDTO 5                // define constante ROUNDTO en 5
#define DEFAULTMODE 0           // define constante DEFAULTMODE en 0
#define DEADZONEAREA 10        // define constante DEADZONEAREA en 10

// Valid Modes
#define CENTERDEADZONE 0         // define constante
#define CENTER 1                // define constante
#define FULL 2                 // define constante
#define TOGGLE 3              // define constante
#define RAW 4                // define constante

class HobbyRadioReceiver
{
private:
	Byte numChannels;       // define variable solo para la función
	Byte* channelPin;
	Byte* mode;
...
public:
	                                        // se permiten infinitos canales pero hasta ahora 255
	HobbyRadioReceiver( Byte num, ... );   // definicion de la funcion
